...
%Moon constants
cst.moon.tilt = deg2rad(6.68);  %wrt to the EM plane, in rad
cst.moon.i    = deg2rad(5.14);  %wrt to the ecliptic plane, in rad

%Earth constants
cst.earth.tilt    = deg2rad(23.44);               %wrt to the ecliptic plane, in rad
cst.earth.tilt2em = cst.earth.tilt + cst.moon.i;  %wrt to the EM plane, in rad
cst.earth.omega   = 27.397453;                    %ECEF wrt to the ECI, in Earth-Moon units (recall that 2pi units of time = one lunar period)

% Mars constants
cst.mars.tilt     = deg2rad(23.98);
