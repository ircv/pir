...
default.plot.firstPrimDisp   = true;  %is the first primary (e.g. the Sun in the Sun-Earth system) displayed?
default.plot.allLibPoints    = true;  %are all libration points displayed?
